...
class Transaction{
    constructor(fromAddress, toAddress, amount,vote){
 ...
 getVoteOfAddress(address,a){
    ...
    for(const block of this.chain){
        for(const trans of block.transactions){
            ...
            if(trans.toAddress === address && (t.getBalanceOfAddress(a))===1 && trans.amount===1 && trans.vote===1 ){
                balance += trans.vote;
            }
        }
    }
